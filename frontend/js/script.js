...
const i18nDict = {
  ...
  en: {
    ...
    'about-c2-t':'Education','about-c2-d':'Technical degree in Web Development from FIEB (2021–2023). Currently studying Systems Analysis and Development at Universidade Cruzeiro do Sul (2024–present), focused on agile methodologies and prototyping in Figma.',
    'about-c3-t':'Skills & Tools','about-c3-d':'Java, Node.js, MySQL and Python, always improving. Google Cloud Computing Foundations certification, Power BI dashboards (DAX/ETL), and first steps into AWS and Google Cloud.',
    ...
    'p3-t':'Visual Identity — F M Locação','p3-d':'Visual identity consulting for a local business: requirements gathering with the client, logo and digital materials through final delivery.',
